...
@client.on(events.NewMessage(func=lambda e: e.is_group and e.message.voice))
    ...
    match random_int:
        case 1:
            ...
            await client.send_file(
                event.chat.id,
                file=static_path + "/reactions/no-voice-message-alla1.ogg",
        ...
        case 2:
            ...
            await client.send_file(
                event.chat.id,
                file=static_path + "/reactions/no-voice-message-alla2.ogg",
                reply_to=event.message.id,
                voice_note=True,
            )
        case 3:
